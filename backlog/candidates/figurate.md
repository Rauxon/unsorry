...
- [x] `sum_product_consecutive_odds_closed_form` — Three times the sum of products of consecutive odd numbers (2k-1)(2k+1) equals n(4n^2+6n-1)
...
- [x] `sum_k_mul_succ_sq_closed_form` — Twelve times the sum of k(k+1)^2 equals n(n+1)(n+2)(3n+5)
...
- [x] `sum_decagonal_second_kind_closed_form` — Three times the running sum of the second-kind decagonal terms k(5k+1) equals n(n+1)(5n+4)
...
- [x] `sum_cube_add_id_closed_form` — Four times the sum of (k^3 + k) equals n(n+1)(n^2+n+2)
