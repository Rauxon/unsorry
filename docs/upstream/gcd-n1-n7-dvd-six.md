# Upstream packet: `gcd-n1-n7-dvd-six`
...
Kernel-verified on `main`: `library/Unsorry/GcdN1N7DvdSix.lean` (theorem `gcd_n1_n7_dvd_six`),
through Gate A (build `--wfail`, axiom audit against the standard whitelist, leanchecker
kernel replay, regenerated ADR-011 binding obligation).

## Proposed contribution

The `git apply`-able new-file diff is at [`gcd-n1-n7-dvd-six.patch`](gcd-n1-n7-dvd-six.patch). The target path
`Mathlib/Unsorry/GcdN1N7DvdSix.lean` is a **placeholder** — file placement and the
...
| title | The gcd of n+1 and n+7 always divides 6. |
...
3. **Raise the draft PR with one command** once you've done 1–2 — from the
   unsorry repo root:
   ```
   python3 -m tools.upstream.raise_pr --goal gcd-n1-n7-dvd-six --fork <your-github-user> --understood
   ```
