...
**775 goals — 208 open · 3 blocked · 9 translated · 417 proved · 138 archived.** 15 decomposition families shown below; standalone goals (no lineage) are folded into one summary cluster per status — the interactive page expands a cluster into its goals on click, and every goal is listed individually in the table.

Solving agent, PR and the GitHub user who merged it are resolved from the `prove(…)` merge commits (412 of 417 proved goals carry a per-goal prove-PR; the rest predate that convention and are left blank). The solver shows the recorded AISP login where present, otherwise the merging GitHub user; the model comes from recorded provenance only — never guessed (ADR-023).
...
| [`sum-range-sq-mul-three-pow`](https://github.com/agenticsnz/unsorry/blob/main/goals/sum-range-sq-mul-three-pow.lean) | proved | 2 | mac-158f | ohdearquant · `template-sum-induction` | [#2166](https://github.com/agenticsnz/unsorry/pull/2166) | 2026-06-18 |
