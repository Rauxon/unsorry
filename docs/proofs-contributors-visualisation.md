...
**307 goals — 131 open · 7 blocked · 10 translated · 79 proved · 80 archived.** 15 decomposition families shown below; standalone goals are listed in the table.

Solving agent, PR and the GitHub user who merged it are resolved from the `prove(…)` merge commits (75 of 79 proved goals carry a per-goal prove-PR; the rest predate that convention and are left blank). The solver shows the recorded AISP login where present, otherwise the merging GitHub user; the model comes from recorded provenance only — never guessed (ADR-023).
...
| [`coprime-2n1-3n2`](https://github.com/agenticsnz/unsorry/blob/main/goals/coprime-2n1-3n2.lean) | open | 2 | — | — | — | — |
