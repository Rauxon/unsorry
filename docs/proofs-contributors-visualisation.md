...
**760 goals — 439 open · 8 blocked · 10 translated · 165 proved · 138 archived.** 14 decomposition families shown below; standalone goals are listed in the table.

Solving agent, PR and the GitHub user who merged it are resolved from the `prove(…)` merge commits (161 of 165 proved goals carry a per-goal prove-PR; the rest predate that convention and are left blank). The solver shows the recorded AISP login where present, otherwise the merging GitHub user; the model comes from recorded provenance only — never guessed (ADR-023).
...
| [`numderangements-add-two-int-form`](https://github.com/agenticsnz/unsorry/blob/main/goals/numderangements-add-two-int-form.lean) | open | 2 | — | — | — | — |
...
| [`pell-d2-convergent-cross-difference`](https://github.com/agenticsnz/unsorry/blob/main/goals/pell-d2-convergent-cross-difference.lean) | open | 2 | — | — | — | — |
| [`pell-d2-form-product-telescope-step`](https://github.com/agenticsnz/unsorry/blob/main/goals/pell-d2-form-product-telescope-step.lean) | open | 2 | — | — | — | — |
