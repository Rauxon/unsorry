...
**774 goals — 222 open · 3 blocked · 9 translated · 402 proved · 138 archived.** 15 decomposition families shown below; standalone goals (no lineage) are folded into one summary cluster per status — the interactive page expands a cluster into its goals on click, and every goal is listed individually in the table.

Solving agent, PR and the GitHub user who merged it are resolved from the `prove(…)` merge commits (397 of 402 proved goals carry a per-goal prove-PR; the rest predate that convention and are left blank). The solver shows the recorded AISP login where present, otherwise the merging GitHub user; the model comes from recorded provenance only — never guessed (ADR-023).
...
| [`sum-range-k-mul-two-pow-eq`](https://github.com/agenticsnz/unsorry/blob/main/goals/sum-range-k-mul-two-pow-eq.lean) | open | 2 | — | — | — | — |
...
| [`sum-range-k-sq-mul-five-pow-closed`](https://github.com/agenticsnz/unsorry/blob/main/goals/sum-range-k-sq-mul-five-pow-closed.lean) | open | 2 | — | — | — | — |
...
| [`sum-stella-octangula-closed-form`](https://github.com/agenticsnz/unsorry/blob/main/goals/sum-stella-octangula-closed-form.lean) | open | 2 | — | — | — | — |
