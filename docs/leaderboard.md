...
**1262 verified proofs · 954 attributed · 308 historical/unknown · 410 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 91 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 22.2% |
| Provider attempts | 453 |
| Failed attempts | 362 |
| Attempt yield | 20.1% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 31s / 32m 0s |
| Verified successes per recorded hour | 1.02 |
| Proofs with run telemetry | 91 (7.2%) |

## Work Queue

**1428 goals · 1173 archived · 3 blocked · 154 open · 89 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 793 | 792 | 1 | 77 | 100.0% | 1698 | 189625 |
...
**954 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1262 of 1262 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 324 | 77 | 100.0% | 0 | 1 | 0s | — |
