...
**2846 verified proofs · 2538 attributed · 308 historical/unknown · 1296 logged terminal runs.**
...
| Provider attempts | 1382 |
| Failed attempts | 427 |
| Attempt yield | 69.1% |
| Recorded run time | 92h 55m |
| Median / p90 run time | 0s / 16m 52s |
| Verified successes per recorded hour | 10.28 |
| Proofs with run telemetry | 955 (33.6%) |

## Work Queue

**2869 goals · 1893 archived · 3 blocked · 11 open · 953 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 993 | 915 | 92.2% | 136 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1793 | 1792 | 1 | 821 | 100.0% | 2670 | 0.0 | 311825 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 565 | 318 | 247 | 0 | — | 1528 | 0.0 | 166925 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1251.0 | 159575 |
...
**2538 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2846 of 2846 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1926 | 936 | 100.0% | 0 | 3 | 0s | — |
