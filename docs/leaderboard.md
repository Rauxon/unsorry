...
**2822 verified proofs · 2514 attributed · 308 historical/unknown · 1272 logged terminal runs.**
...
| Median / p90 run time | 0s / 18m 23s |
| Verified successes per recorded hour | 10.02 |
| Proofs with run telemetry | 931 (33.0%) |

## Work Queue

**2845 goals · 1893 archived · 3 blocked · 11 open · 929 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 969 | 891 | 92.0% | 136 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1769 | 1768 | 1 | 797 | 100.0% | 2646 | 0.0 | 308825 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 565 | 318 | 247 | 0 | — | 1528 | 0.0 | 166925 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1229.4 | 157415 |
...
**2514 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2822 of 2822 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1904 | 914 | 100.0% | 0 | 3 | 0s | — |
