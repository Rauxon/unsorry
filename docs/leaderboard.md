...
**598 verified proofs · 297 attributed · 301 historical/unknown · 556 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 237 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 42.6% |
| Provider attempts | 607 |
| Failed attempts | 370 |
| Attempt yield | 39.0% |
| Recorded run time | 96h 32m |
| Median / p90 run time | 4m 35s / 31m 54s |
| Verified successes per recorded hour | 2.46 |
| Proofs with run telemetry | 234 (39.1%) |

## Work Queue

**782 goals · 258 archived · 3 blocked · 172 open · 340 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 80 | 24 | 30.0% | 71 | 4m 27s |
...
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 163 | 162 | 1 | 164 | 100.0% | 385 | 42575 |
...
**297 explicit solver credits · 301 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 598 of 598 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 6 | 6 | 100.0% | 0 | 1 | 0s | — |
