...
**743 verified proofs · 437 attributed · 306 historical/unknown · 353 logged terminal runs.**
...
| Run success rate | 9.6% |
| Provider attempts | 396 |
| Failed attempts | 362 |
| Attempt yield | 8.6% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 8m 6s / 32m 4s |
| Verified successes per recorded hour | 0.38 |
| Proofs with run telemetry | 34 (4.6%) |

## Work Queue

**913 goals · 703 archived · 3 blocked · 158 open · 40 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 283 | 282 | 1 | 20 | 100.0% | 586 | 65675 |
...
**437 explicit solver credits · 306 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 743 of 743 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-zmod-decide` | 68 | 20 | 100.0% | 0 | 2 | 0s | — |
...
| `2026-06-19T03:34:15Z` | `gzmod-240-pow-fifteen-sub-pow-eleven` | [@ohdearquant](https://github.com/ohdearquant) | `claude / template-zmod-decide` | `proved` | 1 | 0 | 0s |
