...
**1229 verified proofs · 921 attributed · 308 historical/unknown · 417 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 98 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 23.5% |
| Provider attempts | 460 |
| Failed attempts | 362 |
| Attempt yield | 21.3% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 26s / 32m 0s |
| Verified successes per recorded hour | 1.09 |
| Proofs with run telemetry | 98 (8.0%) |

## Work Queue

**1395 goals · 1133 archived · 3 blocked · 154 open · 96 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 114 | 58 | 50.9% | 71 | 3m 2s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 760 | 759 | 1 | 84 | 100.0% | 1661 | 185100 |
...
**921 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1229 of 1229 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 293 | 84 | 100.0% | 0 | 1 | 0s | — |
