...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 895 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 532 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 59.4% |
| Provider attempts | 1019 |
| Failed attempts | 487 |
| Attempt yield | 52.2% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 0s / 31m 39s |
| Verified successes per recorded hour | 4.39 |
| Proofs with run telemetry | 532 (11.5%) |

## Work Queue

**4870 goals · 2777 archived · 15 blocked · 224 open · 1845 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 670 | 513 | 76.6% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 490 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 490 | 100.0% | 0 | 1 | 0s | — |
