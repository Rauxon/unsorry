...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 1201 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 838 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 69.8% |
| Provider attempts | 1325 |
| Failed attempts | 487 |
| Attempt yield | 63.2% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 0s / 31m 21s |
| Verified successes per recorded hour | 6.92 |
| Proofs with run telemetry | 838 (18.2%) |

## Work Queue

**4870 goals · 2471 archived · 15 blocked · 224 open · 2151 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 976 | 819 | 83.9% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 796 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 796 | 100.0% | 0 | 1 | 0s | — |
