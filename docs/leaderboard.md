...
**52 explicit solver credits · 82 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 134 of 134 proof index files. It is used only where explicit `solver≜` provenance is missing.
