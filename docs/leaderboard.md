...
**1319 verified proofs · 1011 attributed · 308 historical/unknown · 427 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 108 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 25.3% |
| Provider attempts | 470 |
| Failed attempts | 362 |
| Attempt yield | 23.0% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 5m 51s / 32m 0s |
| Verified successes per recorded hour | 1.21 |
| Proofs with run telemetry | 108 (8.2%) |

## Work Queue

**1485 goals · 1213 archived · 3 blocked · 154 open · 106 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 124 | 68 | 54.8% | 71 | 1m 57s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 850 | 849 | 1 | 94 | 100.0% | 1755 | 196750 |
...
**1011 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1319 of 1319 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 381 | 94 | 100.0% | 0 | 1 | 0s | — |
