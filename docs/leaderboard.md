...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 861 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 498 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 57.8% |
| Provider attempts | 985 |
| Failed attempts | 487 |
| Attempt yield | 50.6% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 0s / 31m 42s |
| Verified successes per recorded hour | 4.11 |
| Proofs with run telemetry | 498 (10.8%) |

## Work Queue

**4870 goals · 2811 archived · 15 blocked · 224 open · 1811 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 636 | 479 | 75.3% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 456 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 456 | 100.0% | 0 | 1 | 0s | — |
