...
**121 verified proofs · 39 attributed · 82 historical/unknown · 118 logged terminal runs.**
...
| Failed terminal runs | 83 |
| Decomposed after failure | 12 |
| Failed without decomposition | 71 |
| Run success rate | 29.7% |
| Provider attempts | 150 |
| Failed attempts | 115 |
| Attempt yield | 23.3% |
| Recorded run time | 20h 14m |
| Median / p90 run time | 4m 56s / 31m 43s |
| Verified successes per recorded hour | 1.73 |
