...
**1115 verified proofs · 807 attributed · 308 historical/unknown · 383 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 64 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 16.7% |
| Provider attempts | 426 |
| Failed attempts | 362 |
| Attempt yield | 15.0% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 7m 9s / 32m 2s |
| Verified successes per recorded hour | 0.71 |
| Proofs with run telemetry | 64 (5.7%) |

## Work Queue

**1281 goals · 1053 archived · 3 blocked · 154 open · 62 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 646 | 645 | 1 | 50 | 100.0% | 1545 | 170650 |
...
**807 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1115 of 1115 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 180 | 39 | 100.0% | 0 | 1 | 0s | — |
