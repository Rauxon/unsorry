...
**215 verified proofs · 81 attributed · 134 historical/unknown · 277 logged terminal runs.**
...
| Run success rate | 30.7% |
| Provider attempts | 326 |
| Failed attempts | 241 |
| Attempt yield | 26.1% |
| Recorded run time | 54h 21m |
| Median / p90 run time | 6m 28s / 31m 54s |
| Verified successes per recorded hour | 1.56 |
| Proofs with run telemetry | 85 (39.5%) |

## Work Queue

**659 goals · 80 archived · 7 blocked · 429 open · 133 proved · 10 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 102 | 55 | 47 | 202 | 29.2% | 177 | 20250 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 73 | 0 | 73 | 0 | — | 156 | 17425 |
...
**81 explicit solver credits · 134 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 215 of 215 proof index files. It is used only where explicit `solver≜` provenance is missing.
