...
**3387 verified proofs · 3079 attributed · 308 historical/unknown · 1261 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 920 |
...
| Median / p90 run time | 0s / 18m 58s |
| Verified successes per recorded hour | 9.90 |
| Proofs with run telemetry | 920 (27.2%) |

## Work Queue

**3410 goals · 2097 archived · 3 blocked · 11 open · 1290 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 1064 | 913 | 85.8% | 211 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1877 | 1876 | 1 | 786 | 100.0% | 1880 | 0.0 | 234925 |
| 2 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 287 | 1671.3 | 200605 |
| 3 | [@chat-bit-01](https://github.com/chat-bit-01) | 1022 | 775 | 247 | 0 | — | 1353 | 0.0 | 160850 |
...
**3079 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 3387 of 3387 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2012 | 903 | 100.0% | 0 | 3 | 0s | — |
