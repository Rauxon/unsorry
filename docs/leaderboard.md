...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 929 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 566 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 60.9% |
| Provider attempts | 1053 |
| Failed attempts | 487 |
| Attempt yield | 53.8% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 0s / 31m 34s |
| Verified successes per recorded hour | 4.67 |
| Proofs with run telemetry | 566 (12.3%) |

## Work Queue

**4870 goals · 2743 archived · 15 blocked · 224 open · 1879 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 704 | 547 | 77.7% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 524 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 524 | 100.0% | 0 | 1 | 0s | — |
