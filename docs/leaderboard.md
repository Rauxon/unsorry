...
**1237 verified proofs · 929 attributed · 308 historical/unknown · 425 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 106 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 24.9% |
| Provider attempts | 468 |
| Failed attempts | 362 |
| Attempt yield | 22.7% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 5s / 32m 0s |
| Verified successes per recorded hour | 1.18 |
| Proofs with run telemetry | 106 (8.6%) |

## Work Queue

**1403 goals · 1133 archived · 3 blocked · 154 open · 104 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 122 | 66 | 54.1% | 71 | 2m 38s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 768 | 767 | 1 | 92 | 100.0% | 1669 | 186100 |
...
**929 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1237 of 1237 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-zmod-decide` | 339 | 0 | — | 0 | 2 | — | — |
| `claude / template-ring-cofactor` | 301 | 92 | 100.0% | 0 | 1 | 0s | — |
