...
**3141 verified proofs · 2833 attributed · 308 historical/unknown · 1326 logged terminal runs.**
...
| Proofs with run telemetry | 985 (31.4%) |

## Work Queue

**3164 goals · 1995 archived · 3 blocked · 11 open · 1146 proved · 9 translated.**
...
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 776 | 529 | 247 | 0 | — | 2413 | 0.0 | 260700 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1463.4 | 180815 |
...
**2833 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 3141 of 3141 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-induction-ring` | 78 | 0 | — | 0 | 1 | — | — |
| `claude / opus` | 59 | 31 | 41.9% | 54 | 5 | 8m 34s | 2.33 |
| `seedkit / template-induction-ring` | 48 | 0 | — | 0 | 1 | — | — |
