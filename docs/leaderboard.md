...
**600 verified proofs · 299 attributed · 301 historical/unknown · 558 logged terminal runs.**
...
| Provider attempts | 609 |
| Failed attempts | 370 |
| Attempt yield | 39.2% |
| Recorded run time | 96h 32m |
| Median / p90 run time | 4m 31s / 31m 54s |
| Verified successes per recorded hour | 2.48 |
| Proofs with run telemetry | 236 (39.3%) |

## Work Queue

**784 goals · 258 archived · 3 blocked · 172 open · 342 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 82 | 26 | 31.7% | 71 | 4m 16s |
...
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 165 | 164 | 1 | 166 | 100.0% | 387 | 42825 |
...
**299 explicit solver credits · 301 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 600 of 600 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 8 | 8 | 100.0% | 0 | 1 | 0s | — |
