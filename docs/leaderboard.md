...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 963 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 600 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 62.3% |
| Provider attempts | 1087 |
| Failed attempts | 487 |
| Attempt yield | 55.2% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 0s / 31m 33s |
| Verified successes per recorded hour | 4.96 |
| Proofs with run telemetry | 600 (13.0%) |

## Work Queue

**4870 goals · 2709 archived · 15 blocked · 224 open · 1913 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 738 | 581 | 78.7% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 558 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 558 | 100.0% | 0 | 1 | 0s | — |
