...
**4423 verified proofs · 4115 attributed · 308 historical/unknown · 1226 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 869 |
| Failed terminal runs | 357 |
| Decomposed after failure | 29 |
| Failed without decomposition | 328 |
| Run success rate | 70.9% |
| Provider attempts | 1343 |
| Failed attempts | 474 |
| Attempt yield | 64.7% |
| Recorded run time | 114h 43m |
| Median / p90 run time | 0s / 31m 21s |
| Verified successes per recorded hour | 7.58 |
| Proofs with run telemetry | 869 (19.7%) |

## Work Queue

**4680 goals · 2199 archived · 12 blocked · 224 open · 2236 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 1006 | 850 | 84.5% | 227 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 280 | 5.4% | 216 | 2642.4 | 288840 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2357 | 18.9 | 288165 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2042 | 2041 | 1 | 829 | 100.0% | 2045 | 0.0 | 255550 |
...
**4115 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4423 of 4423 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2039 | 828 | 100.0% | 0 | 1 | 0s | — |
| `lean / ring` | 1118 | 0 | — | 0 | 1 | — | — |
