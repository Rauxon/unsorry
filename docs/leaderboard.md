...
**753 verified proofs · 446 attributed · 307 historical/unknown · 361 logged terminal runs.**
...
| Run success rate | 11.6% |
| Provider attempts | 404 |
| Failed attempts | 362 |
| Attempt yield | 10.4% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 7m 58s / 32m 4s |
| Verified successes per recorded hour | 0.47 |
| Proofs with run telemetry | 42 (5.6%) |

## Work Queue

**921 goals · 703 archived · 3 blocked · 156 open · 50 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 67 | 11 | 16.4% | 71 | 5m 24s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 291 | 290 | 1 | 28 | 100.0% | 602 | 67475 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 262 | 16 | 246 | 0 | — | 619 | 68450 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 118 | 71 | 47 | 265 | 4.9% | 212 | 24150 |
| 4 | [@perttu](https://github.com/perttu) | 38 | 34 | 4 | 13 | 7.7% | 84 | 9350 |
| 5 | [@ruvnet](https://github.com/ruvnet) | 24 | 24 | 0 | 0 | — | 63 | 6900 |
...
**446 explicit solver credits · 307 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 753 of 753 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 86 | 4 | 100.0% | 0 | 1 | 0s | — |
| `claude / template-zmod-decide` | 72 | 24 | 100.0% | 0 | 2 | 0s | — |
