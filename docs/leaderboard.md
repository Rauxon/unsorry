...
**2722 verified proofs · 2414 attributed · 308 historical/unknown · 1206 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 865 |
| Failed terminal runs | 341 |
| Decomposed after failure | 20 |
| Failed without decomposition | 321 |
| Run success rate | 71.7% |
| Provider attempts | 1292 |
| Failed attempts | 427 |
| Attempt yield | 67.0% |
| Recorded run time | 92h 55m |
| Median / p90 run time | 0s / 31m 16s |
| Verified successes per recorded hour | 9.31 |
| Proofs with run telemetry | 865 (31.8%) |

## Work Queue

**2745 goals · 1859 archived · 3 blocked · 11 open · 863 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 903 | 825 | 91.4% | 136 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1669 | 1668 | 1 | 731 | 100.0% | 2546 | 0.0 | 296325 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 565 | 318 | 247 | 0 | — | 1528 | 0.0 | 166925 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1157.4 | 150215 |
...
**2414 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2722 of 2722 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1804 | 848 | 100.0% | 0 | 3 | 0s | — |
