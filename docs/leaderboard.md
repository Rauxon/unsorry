...
**1132 verified proofs · 824 attributed · 308 historical/unknown · 400 logged terminal runs.**
...
| Run success rate | 20.2% |
| Provider attempts | 443 |
| Failed attempts | 362 |
| Attempt yield | 18.3% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 42s / 32m 1s |
| Verified successes per recorded hour | 0.90 |
| Proofs with run telemetry | 81 (7.2%) |

## Work Queue

**1298 goals · 1053 archived · 3 blocked · 154 open · 79 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 86 | 30 | 34.9% | 71 | 4m 1s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 663 | 662 | 1 | 67 | 100.0% | 1562 | 172775 |
...
**824 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1132 of 1132 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 197 | 56 | 100.0% | 0 | 1 | 0s | — |
