...
**1282 verified proofs · 974 attributed · 308 historical/unknown · 430 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 111 |
...
| Median / p90 run time | 5m 45s / 32m 0s |
| Verified successes per recorded hour | 1.24 |
| Proofs with run telemetry | 111 (8.7%) |

## Work Queue

**1448 goals · 1173 archived · 3 blocked · 154 open · 109 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 813 | 812 | 1 | 97 | 100.0% | 1718 | 192125 |
...
**974 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1282 of 1282 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 344 | 97 | 100.0% | 0 | 1 | 0s | — |
