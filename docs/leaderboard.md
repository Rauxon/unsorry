...
**1258 verified proofs · 950 attributed · 308 historical/unknown · 406 logged terminal runs.**
...
| Median / p90 run time | 6m 36s / 32m 1s |
| Verified successes per recorded hour | 0.97 |
| Proofs with run telemetry | 87 (6.9%) |

## Work Queue

**1424 goals · 1173 archived · 3 blocked · 154 open · 85 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 103 | 47 | 45.6% | 71 | 3m 33s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 789 | 788 | 1 | 73 | 100.0% | 1694 | 189125 |
...
**950 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1258 of 1258 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 320 | 73 | 100.0% | 0 | 1 | 0s | — |
