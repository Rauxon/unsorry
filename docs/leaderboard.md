...
**499 verified proofs · 208 attributed · 291 historical/unknown · 487 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 168 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 34.5% |
| Provider attempts | 537 |
| Failed attempts | 369 |
| Attempt yield | 31.3% |
| Recorded run time | 98h 5m |
| Median / p90 run time | 5m 56s / 31m 57s |
| Verified successes per recorded hour | 1.71 |
| Proofs with run telemetry | 168 (33.7%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 251 open · 361 proved · 9 translated.**
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 82 | 82 | 0 | 82 | 100.0% | 196 | 21650 |
...
**208 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 499 of 499 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-sum-induction` | 7 | 7 | 100.0% | 0 | 1 | 0s | — |
