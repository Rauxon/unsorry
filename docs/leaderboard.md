...
**4548 verified proofs · 4240 attributed · 308 historical/unknown · 1339 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 980 |
| Failed terminal runs | 359 |
| Decomposed after failure | 30 |
| Failed without decomposition | 329 |
| Run success rate | 73.2% |
| Provider attempts | 1459 |
| Failed attempts | 479 |
| Attempt yield | 67.2% |
| Recorded run time | 117h 17m |
| Median / p90 run time | 0s / 31m 18s |
| Verified successes per recorded hour | 8.36 |
| Proofs with run telemetry | 980 (21.6%) |

## Work Queue

**4807 goals · 2267 archived · 13 blocked · 225 open · 2293 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 1117 | 961 | 86.0% | 227 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 282 | 5.3% | 216 | 2753.1 | 299910 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 18.9 | 287865 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2165 | 2164 | 1 | 938 | 100.0% | 2168 | 0.0 | 270925 |
...
**4240 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4548 of 4548 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2163 | 938 | 100.0% | 0 | 1 | 0s | — |
