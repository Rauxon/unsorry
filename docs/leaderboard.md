...
**619 verified proofs · 316 attributed · 303 historical/unknown · 574 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 255 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 44.4% |
| Provider attempts | 625 |
| Failed attempts | 370 |
| Attempt yield | 40.8% |
| Recorded run time | 96h 32m |
| Median / p90 run time | 4m 20s / 31m 52s |
| Verified successes per recorded hour | 2.64 |
| Proofs with run telemetry | 252 (40.7%) |

## Work Queue

**799 goals · 258 archived · 3 blocked · 168 open · 361 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 97 | 41 | 42.3% | 71 | 3m 51s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@chat-bit-01](https://github.com/chat-bit-01) | 242 | 0 | 242 | 0 | — | 556 | 61650 |
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 181 | 180 | 1 | 182 | 100.0% | 404 | 44925 |
...
**316 explicit solver credits · 303 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 619 of 619 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 22 | 22 | 100.0% | 0 | 1 | 0s | — |
...
| `2026-06-17T18:22:27Z` | `gself-pow-four-add-pow-one` | [@ohdearquant](https://github.com/ohdearquant) | `claude / template-ring-cofactor` | `proved` | 1 | 0 | 0s |
...
| `2026-06-17T18:20:01Z` | `ggeom-pred-pow-ten-sub-one` | [@ohdearquant](https://github.com/ohdearquant) | `claude / template-ring-cofactor` | `proved` | 1 | 0 | 0s |
