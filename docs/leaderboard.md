...
**4229 verified proofs · 3921 attributed · 308 historical/unknown · 1191 logged terminal runs.**
...
| Proofs with run telemetry | 849 (20.1%) |

## Work Queue

**4464 goals · 2199 archived · 3 blocked · 212 open · 2041 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 334 | 22.5% | 287 | 2411.1 | 274585 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 1844 | 1597 | 247 | 0 | — | 2183 | 18.0 | 266200 |
...
**3921 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4229 of 4229 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-induction-ring` | 4 | 0 | — | 0 | 1 | — | — |
