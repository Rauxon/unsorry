...
**790 verified proofs · 482 attributed · 308 historical/unknown · 392 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 73 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 18.6% |
| Provider attempts | 435 |
| Failed attempts | 362 |
| Attempt yield | 16.8% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 48s / 32m 2s |
| Verified successes per recorded hour | 0.81 |
| Proofs with run telemetry | 73 (9.2%) |

## Work Queue

**956 goals · 703 archived · 3 blocked · 154 open · 87 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 93 | 37 | 39.8% | 71 | 3m 51s |
| 2 | 139 | 1 | 0.7% | 157 | 7m 58s |
| 3 | 137 | 32 | 23.4% | 114 | 8m 27s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 322 | 321 | 1 | 59 | 100.0% | 643 | 72350 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 267 | 20 | 247 | 0 | — | 634 | 70075 |
...
**482 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 790 of 790 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 112 | 30 | 100.0% | 0 | 1 | 0s | — |
| `claude / template-zmod-decide` | 81 | 29 | 100.0% | 0 | 2 | 0s | — |
...
| `2026-06-19T03:36:43Z` | `gzmod-264-pow-eighteen-sub-pow-eight` | [@ohdearquant](https://github.com/ohdearquant) | `claude / template-zmod-decide` | `proved` | 1 | 0 | 0s |
