...
**2705 verified proofs · 2397 attributed · 308 historical/unknown · 1189 logged terminal runs.**
...
| Provider attempts | 1275 |
| Failed attempts | 427 |
| Attempt yield | 66.5% |
| Recorded run time | 92h 55m |
| Median / p90 run time | 0s / 31m 18s |
| Verified successes per recorded hour | 9.13 |
| Proofs with run telemetry | 848 (31.4%) |

## Work Queue

**2728 goals · 1859 archived · 3 blocked · 11 open · 846 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 886 | 808 | 91.2% | 136 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1652 | 1651 | 1 | 714 | 100.0% | 2529 | 0.0 | 294200 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 565 | 318 | 247 | 0 | — | 1528 | 0.0 | 166925 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1143.0 | 148775 |
...
**2397 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2705 of 2705 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1787 | 831 | 100.0% | 0 | 3 | 0s | — |
