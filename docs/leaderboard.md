...
**2857 verified proofs · 2549 attributed · 308 historical/unknown · 1307 logged terminal runs.**
...
| Run success rate | 73.9% |
| Provider attempts | 1393 |
| Failed attempts | 427 |
| Attempt yield | 69.3% |
| Recorded run time | 92h 55m |
| Median / p90 run time | 0s / 16m 48s |
| Verified successes per recorded hour | 10.39 |
| Proofs with run telemetry | 966 (33.8%) |

## Work Queue

**2880 goals · 1893 archived · 3 blocked · 11 open · 964 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 1004 | 926 | 92.2% | 136 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1804 | 1803 | 1 | 832 | 100.0% | 2681 | 0.0 | 313200 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 565 | 318 | 247 | 0 | — | 1528 | 0.0 | 166925 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1259.1 | 160385 |
...
**2549 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2857 of 2857 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1939 | 949 | 100.0% | 0 | 3 | 0s | — |
