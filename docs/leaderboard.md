...
**145 verified proofs · 62 attributed · 83 historical/unknown · 156 logged terminal runs.**
...
| Provider attempts | 194 |
| Failed attempts | 137 |
| Attempt yield | 29.4% |
| Recorded run time | 26h 19m |
| Median / p90 run time | 4m 52s / 31m 43s |
| Verified successes per recorded hour | 2.17 |
| Proofs with run telemetry | 57 (39.3%) |

## Work Queue

**259 goals · 80 archived · 11 blocked · 95 open · 63 proved · 10 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 48 | 14 | 29.2% | 47 | 5m 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 84 | 42 | 42 | 124 | 33.1% | 148 | 16900 |
...
**62 explicit solver credits · 83 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 145 of 145 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / opus` | 36 | 39 | 92.3% | 17 | 3 | 4m 55s | 6.72 |
