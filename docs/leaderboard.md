...
**525 verified proofs · 234 attributed · 291 historical/unknown · 507 logged terminal runs.**
...
| Provider attempts | 557 |
| Failed attempts | 369 |
| Attempt yield | 33.8% |
| Recorded run time | 98h 5m |
| Median / p90 run time | 5m 28s / 31m 56s |
| Verified successes per recorded hour | 1.92 |
| Proofs with run telemetry | 188 (35.8%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 225 open · 387 proved · 9 translated.**
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 102 | 102 | 0 | 102 | 100.0% | 243 | 26850 |
...
**234 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 525 of 525 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-sum-induction` | 23 | 23 | 100.0% | 0 | 1 | 0s | — |
...
| `claude / template-sum-closedform` | 2 | 2 | 100.0% | 0 | 1 | 0s | — |
