...
**1164 verified proofs · 856 attributed · 308 historical/unknown · 392 logged terminal runs.**
...
| Proofs with run telemetry | 73 (6.3%) |

## Work Queue

**1330 goals · 1093 archived · 3 blocked · 154 open · 71 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 695 | 694 | 1 | 59 | 100.0% | 1596 | 176975 |
...
**856 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1164 of 1164 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 228 | 59 | 100.0% | 0 | 1 | 0s | — |
