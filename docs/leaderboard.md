...
**566 verified proofs · 272 attributed · 294 historical/unknown · 545 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 226 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 41.5% |
| Provider attempts | 597 |
| Failed attempts | 371 |
| Attempt yield | 37.9% |
| Recorded run time | 98h 15m |
| Median / p90 run time | 4m 53s / 31m 54s |
| Verified successes per recorded hour | 2.30 |
| Proofs with run telemetry | 225 (39.8%) |

## Work Queue

**776 goals · 138 archived · 3 blocked · 198 open · 428 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@chat-bit-01](https://github.com/chat-bit-01) | 233 | 0 | 233 | 0 | — | 526 | 58425 |
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 138 | 138 | 0 | 139 | 100.0% | 328 | 36250 |
...
**272 explicit solver credits · 294 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 566 of 566 proof index files. It is used only where explicit `solver≜` provenance is missing.
