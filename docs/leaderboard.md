...
**2535 verified proofs · 2227 attributed · 308 historical/unknown · 1116 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 780 |
| Failed terminal runs | 336 |
| Decomposed after failure | 20 |
| Failed without decomposition | 316 |
| Run success rate | 69.9% |
| Provider attempts | 1194 |
| Failed attempts | 414 |
| Attempt yield | 65.3% |
| Recorded run time | 92h 26m |
| Median / p90 run time | 0s / 31m 20s |
| Verified successes per recorded hour | 8.44 |
| Proofs with run telemetry | 780 (30.8%) |

## Work Queue

**2558 goals · 1757 archived · 3 blocked · 11 open · 778 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 813 | 740 | 91.0% | 123 | 0s |
...
|------|--------|-----------:|-----:|----------------:|--------------:|
| `sq-add-sq-eq-three-mul-sq-s4-s3-s2` | `open` | 1 | 13 | 39 | 2h 2m |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1483 | 1482 | 1 | 646 | 100.0% | 2360 | 0.0 | 273075 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 564 | 317 | 247 | 0 | — | 1525 | 0.0 | 166600 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 330 | 22.1% | 297 | 1013.4 | 135815 |
| 4 | [@ruvnet](https://github.com/ruvnet) | 160 | 160 | 0 | 0 | — | 429 | 0.0 | 46900 |
| 5 | [@perttu](https://github.com/perttu) | 106 | 102 | 4 | 81 | 72.8% | 170 | 141.3 | 33780 |
...
**2227 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2535 of 2535 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1617 | 762 | 100.0% | 0 | 3 | 0s | — |
| `lean / decide` | 317 | 0 | — | 0 | 1 | — | — |
| `openrouter / unknown` | 160 | 0 | — | 0 | 1 | — | — |
| `claude / opus` | 59 | 27 | 48.1% | 44 | 5 | 9m 38s | 2.52 |
| `codex / unknown` | 39 | 74 | 5.4% | 108 | 2 | 7m 36s | 0.35 |
