...
**121 verified proofs · 39 attributed · 82 historical/unknown · 119 logged terminal runs.**
...
| Failed terminal runs | 84 |
| Decomposed after failure | 12 |
| Failed without decomposition | 72 |
| Run success rate | 29.4% |
| Provider attempts | 151 |
| Failed attempts | 116 |
| Attempt yield | 23.2% |
| Recorded run time | 20h 46m |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 68 | 26 | 42 | 96 | 27.1% | 111 | 12800 |
...
| `openai / leanstral-2603` | 7 | 70 | 10.0% | 67 | 1 | 4m 42s | 0.56 |
