...
**2029 verified proofs · 1721 attributed · 308 historical/unknown · 709 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 378 |
| Failed terminal runs | 331 |
| Decomposed after failure | 20 |
| Failed without decomposition | 311 |
| Run success rate | 53.3% |
| Provider attempts | 777 |
| Failed attempts | 399 |
| Attempt yield | 48.6% |
| Recorded run time | 91h 34m |
| Median / p90 run time | 0s / 31m 39s |
| Verified successes per recorded hour | 4.13 |
| Proofs with run telemetry | 378 (18.6%) |

## Work Queue

**2054 goals · 1485 archived · 3 blocked · 13 open · 544 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 406 | 338 | 83.2% | 108 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1013 | 1012 | 1 | 243 | 100.0% | 1890 | 0.0 | 214325 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 530 | 283 | 247 | 0 | — | 1423 | 0.0 | 155550 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 329 | 22.2% | 297 | 596.7 | 94145 |
| 4 | [@ruvnet](https://github.com/ruvnet) | 158 | 158 | 0 | 0 | — | 422 | 0.0 | 46150 |
| 5 | [@perttu](https://github.com/perttu) | 106 | 102 | 4 | 78 | 76.9% | 170 | 123.3 | 31980 |
...
**1721 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2029 of 2029 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1148 | 361 | 100.0% | 0 | 3 | 0s | — |
| `lean / decide` | 283 | 0 | — | 0 | 1 | — | — |
