...
**4060 verified proofs · 3752 attributed · 308 historical/unknown · 1187 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 845 |
| Failed terminal runs | 342 |
| Decomposed after failure | 20 |
| Failed without decomposition | 322 |
| Run success rate | 71.2% |
| Provider attempts | 1276 |
| Failed attempts | 431 |
| Attempt yield | 66.2% |
| Recorded run time | 95h 17m |
| Median / p90 run time | 0s / 31m 18s |
| Verified successes per recorded hour | 8.87 |
| Proofs with run telemetry | 845 (20.8%) |

## Work Queue

**4132 goals · 2199 archived · 3 blocked · 53 open · 1868 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 332 | 22.0% | 287 | 2259.0 | 259375 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 1675 | 1428 | 247 | 0 | — | 2002 | 18.0 | 243875 |
...
| 8 | [@Rauxon](https://github.com/Rauxon) | 2 | 2 | 0 | 13 | 69.2% | 2 | 0.0 | 250 |
| 9 | [@yarcles](https://github.com/yarcles) | 1 | 1 | 0 | 0 | — | 1 | 0.0 | 125 |

## Attribution Notes

**3752 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4060 of 4060 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / opus` | 59 | 39 | 51.3% | 58 | 5 | 8m 21s | 2.52 |
