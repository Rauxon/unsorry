...
**4371 verified proofs · 4063 attributed · 308 historical/unknown · 1205 logged terminal runs.**
...
| Proofs with run telemetry | 859 (19.7%) |

## Work Queue

**4612 goals · 2199 archived · 7 blocked · 213 open · 2184 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 192 | 145 | 47 | 340 | 22.7% | 288 | 2534.4 | 287040 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 1981 | 1734 | 247 | 4 | 100.0% | 2312 | 18.0 | 282525 |
...
**4063 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4371 of 4371 proof index files. It is used only where explicit `solver≜` provenance is missing.
