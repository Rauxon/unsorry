...
**4486 verified proofs · 4178 attributed · 308 historical/unknown · 1290 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 932 |
| Failed terminal runs | 358 |
| Decomposed after failure | 29 |
| Failed without decomposition | 329 |
| Run success rate | 72.2% |
| Provider attempts | 1409 |
| Failed attempts | 477 |
| Attempt yield | 66.1% |
| Recorded run time | 116h 13m |
| Median / p90 run time | 0s / 31m 19s |
| Verified successes per recorded hour | 8.02 |
| Proofs with run telemetry | 932 (20.8%) |

## Work Queue

**4743 goals · 2233 archived · 12 blocked · 224 open · 2265 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 1069 | 913 | 85.4% | 227 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 281 | 5.3% | 216 | 2699.1 | 294510 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 18.9 | 287865 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2105 | 2104 | 1 | 892 | 100.0% | 2108 | 0.0 | 263425 |
...
**4178 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4486 of 4486 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2103 | 892 | 100.0% | 0 | 1 | 0s | — |
