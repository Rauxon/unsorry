...
**4361 verified proofs · 4053 attributed · 308 historical/unknown · 1204 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 858 |
| Failed terminal runs | 346 |
| Decomposed after failure | 24 |
| Failed without decomposition | 322 |
| Run success rate | 71.3% |
| Provider attempts | 1301 |
| Failed attempts | 443 |
| Attempt yield | 66.0% |
| Recorded run time | 102h 51m |
| Median / p90 run time | 0s / 31m 19s |
| Verified successes per recorded hour | 8.34 |
| Proofs with run telemetry | 858 (19.7%) |

## Work Queue

**4603 goals · 2199 archived · 7 blocked · 214 open · 2174 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 991 | 839 | 84.7% | 215 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 339 | 22.4% | 287 | 2526.3 | 286105 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 1972 | 1725 | 247 | 4 | 100.0% | 2309 | 18.0 | 282000 |
...
**4053 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4361 of 4361 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `lean / ring` | 1067 | 0 | — | 0 | 1 | — | — |
| `lean / decide` | 652 | 0 | — | 0 | 1 | — | — |
| `openrouter / unknown` | 160 | 0 | — | 0 | 1 | — | — |
| `claude / opus` | 67 | 56 | 58.9% | 70 | 6 | 9m 38s | 2.13 |
...
| `claude / template-induction-ring` | 2 | 0 | — | 0 | 1 | — | — |
