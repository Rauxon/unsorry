...
**4570 verified proofs · 4262 attributed · 308 historical/unknown · 1362 logged terminal runs.**
...
| Provider attempts | 1484 |
| Failed attempts | 482 |
| Attempt yield | 67.5% |
| Recorded run time | 118h 50m |
| Median / p90 run time | 0s / 31m 17s |
| Verified successes per recorded hour | 8.43 |
| Proofs with run telemetry | 1002 (21.9%) |

## Work Queue

**4833 goals · 2267 archived · 14 blocked · 228 open · 2315 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 283 | 5.3% | 216 | 2772.9 | 301890 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 18.9 | 287865 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2187 | 2186 | 1 | 960 | 100.0% | 2190 | 0.0 | 273675 |
...
**4262 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4570 of 4570 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2185 | 960 | 100.0% | 0 | 1 | 0s | — |
