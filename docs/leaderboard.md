...
**813 verified proofs · 505 attributed · 308 historical/unknown · 414 logged terminal runs.**
...
| Run success rate | 22.9% |
| Provider attempts | 457 |
| Failed attempts | 362 |
| Attempt yield | 20.8% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 29s / 32m 0s |
| Verified successes per recorded hour | 1.06 |
| Proofs with run telemetry | 95 (11.7%) |

## Work Queue

**979 goals · 703 archived · 3 blocked · 154 open · 110 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 344 | 343 | 1 | 81 | 100.0% | 685 | 77100 |
...
**505 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 813 of 813 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-zmod-decide` | 92 | 39 | 100.0% | 0 | 2 | 0s | — |
