...
**1120 verified proofs · 812 attributed · 308 historical/unknown · 388 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 69 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 17.8% |
| Provider attempts | 431 |
| Failed attempts | 362 |
| Attempt yield | 16.0% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 57s / 32m 2s |
| Verified successes per recorded hour | 0.77 |
| Proofs with run telemetry | 69 (6.2%) |

## Work Queue

**1286 goals · 1053 archived · 3 blocked · 154 open · 67 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 74 | 18 | 24.3% | 71 | 4m 37s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 651 | 650 | 1 | 55 | 100.0% | 1550 | 171275 |
...
**812 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1120 of 1120 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 185 | 44 | 100.0% | 0 | 1 | 0s | — |
