...
**4608 verified proofs · 4300 attributed · 308 historical/unknown · 1367 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 1006 |
| Failed terminal runs | 361 |
| Decomposed after failure | 32 |
| Failed without decomposition | 329 |
| Run success rate | 73.6% |
| Provider attempts | 1489 |
| Failed attempts | 483 |
| Attempt yield | 67.6% |
| Recorded run time | 119h 11m |
| Median / p90 run time | 0s / 31m 17s |
| Verified successes per recorded hour | 8.44 |
| Proofs with run telemetry | 1006 (21.8%) |

## Work Queue

**4870 goals · 2301 archived · 15 blocked · 226 open · 2319 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 1143 | 986 | 86.3% | 230 | 0s |
| 2 | 113 | 5 | 4.4% | 125 | 6m 48s |
| 3 | 68 | 4 | 5.9% | 73 | 9m 21s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 284 | 5.3% | 216 | 2807.1 | 305310 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 18.9 | 287865 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2225 | 2224 | 1 | 964 | 100.0% | 2230 | 0.0 | 278625 |
...
**4300 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4608 of 4608 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2223 | 964 | 100.0% | 0 | 1 | 0s | — |
