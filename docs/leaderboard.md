...
**1231 verified proofs · 923 attributed · 308 historical/unknown · 419 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 100 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 23.9% |
| Provider attempts | 462 |
| Failed attempts | 362 |
| Attempt yield | 21.6% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 26s / 32m 0s |
| Verified successes per recorded hour | 1.12 |
| Proofs with run telemetry | 100 (8.1%) |

## Work Queue

**1397 goals · 1133 archived · 3 blocked · 154 open · 98 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 116 | 60 | 51.7% | 71 | 2m 58s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 762 | 761 | 1 | 86 | 100.0% | 1663 | 185350 |
...
**923 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1231 of 1231 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 295 | 86 | 100.0% | 0 | 1 | 0s | — |
