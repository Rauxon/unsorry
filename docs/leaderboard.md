...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 997 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 634 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 63.6% |
| Provider attempts | 1121 |
| Failed attempts | 487 |
| Attempt yield | 56.6% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 0s / 31m 30s |
| Verified successes per recorded hour | 5.24 |
| Proofs with run telemetry | 634 (13.8%) |

## Work Queue

**4870 goals · 2675 archived · 15 blocked · 224 open · 1947 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 772 | 615 | 79.7% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 592 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 592 | 100.0% | 0 | 1 | 0s | — |
