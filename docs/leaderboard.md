...
**1329 verified proofs · 1021 attributed · 308 historical/unknown · 437 logged terminal runs.**
...
| Run success rate | 27.0% |
| Provider attempts | 480 |
| Failed attempts | 362 |
| Attempt yield | 24.6% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 5m 32s / 32m 0s |
| Verified successes per recorded hour | 1.32 |
| Proofs with run telemetry | 118 (8.9%) |

## Work Queue

**1495 goals · 1213 archived · 3 blocked · 154 open · 116 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 860 | 859 | 1 | 104 | 100.0% | 1765 | 198000 |
...
**1021 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1329 of 1329 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 391 | 104 | 100.0% | 0 | 1 | 0s | — |
