...
**535 verified proofs · 244 attributed · 291 historical/unknown · 516 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 197 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 38.2% |
| Provider attempts | 568 |
| Failed attempts | 371 |
| Attempt yield | 34.7% |
| Recorded run time | 98h 15m |
| Median / p90 run time | 5m 24s / 31m 55s |
| Verified successes per recorded hour | 2.00 |
| Proofs with run telemetry | 197 (36.8%) |

## Work Queue

**774 goals · 138 archived · 3 blocked · 227 open · 397 proved · 9 translated.**
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 110 | 110 | 0 | 110 | 100.0% | 263 | 29050 |
...
**244 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 535 of 535 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-sum-induction` | 28 | 28 | 100.0% | 0 | 1 | 0s | — |
