...
**3084 verified proofs · 2776 attributed · 308 historical/unknown · 1326 logged terminal runs.**
...
| Proofs with run telemetry | 985 (31.9%) |

## Work Queue

**3107 goals · 1961 archived · 3 blocked · 11 open · 1123 proved · 9 translated.**
...
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 719 | 472 | 247 | 0 | — | 2128 | 0.0 | 230775 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1421.1 | 176585 |
...
**2776 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 3084 of 3084 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-induction-ring` | 63 | 0 | — | 0 | 1 | — | — |
...
| `seedkit / template-induction-ring` | 6 | 0 | — | 0 | 1 | — | — |
