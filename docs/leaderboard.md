...
**1168 verified proofs · 860 attributed · 308 historical/unknown · 396 logged terminal runs.**
...
| Proofs with run telemetry | 77 (6.6%) |

## Work Queue

**1334 goals · 1093 archived · 3 blocked · 154 open · 75 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 699 | 698 | 1 | 63 | 100.0% | 1600 | 177475 |
...
**860 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1168 of 1168 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 232 | 63 | 100.0% | 0 | 1 | 0s | — |
