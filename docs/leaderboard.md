...
**4526 verified proofs · 4218 attributed · 308 historical/unknown · 1331 logged terminal runs.**
...
| Provider attempts | 1451 |
| Failed attempts | 479 |
| Attempt yield | 67.0% |
| Recorded run time | 117h 17m |
| Median / p90 run time | 0s / 31m 18s |
| Verified successes per recorded hour | 8.29 |
| Proofs with run telemetry | 972 (21.5%) |

## Work Queue

**4785 goals · 2233 archived · 13 blocked · 225 open · 2305 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 1109 | 953 | 85.9% | 227 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 282 | 5.3% | 216 | 2733.3 | 297930 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 18.9 | 287865 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2143 | 2142 | 1 | 930 | 100.0% | 2146 | 0.0 | 268175 |
...
**4218 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4526 of 4526 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2141 | 930 | 100.0% | 0 | 1 | 0s | — |
