...
**1276 verified proofs · 968 attributed · 308 historical/unknown · 424 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 105 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 24.8% |
| Provider attempts | 467 |
| Failed attempts | 362 |
| Attempt yield | 22.5% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 6s / 32m 0s |
| Verified successes per recorded hour | 1.17 |
| Proofs with run telemetry | 105 (8.2%) |

## Work Queue

**1442 goals · 1173 archived · 3 blocked · 154 open · 103 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 121 | 65 | 53.7% | 71 | 2m 44s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 807 | 806 | 1 | 91 | 100.0% | 1712 | 191375 |
...
**968 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1276 of 1276 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 338 | 91 | 100.0% | 0 | 1 | 0s | — |
