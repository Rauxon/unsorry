...
**812 verified proofs · 504 attributed · 308 historical/unknown · 413 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 94 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 22.8% |
| Provider attempts | 456 |
| Failed attempts | 362 |
| Attempt yield | 20.6% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 30s / 32m 0s |
| Verified successes per recorded hour | 1.05 |
| Proofs with run telemetry | 94 (11.6%) |

## Work Queue

**978 goals · 703 archived · 3 blocked · 154 open · 109 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 343 | 342 | 1 | 80 | 100.0% | 682 | 76775 |
...
**504 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 812 of 812 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-zmod-decide` | 91 | 38 | 100.0% | 0 | 2 | 0s | — |
