...
**480 verified proofs · 189 attributed · 291 historical/unknown · 472 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 153 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 32.4% |
| Provider attempts | 522 |
| Failed attempts | 369 |
| Attempt yield | 29.3% |
| Recorded run time | 98h 5m |
| Median / p90 run time | 6m 27s / 31m 58s |
| Verified successes per recorded hour | 1.56 |
| Proofs with run telemetry | 153 (31.9%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 270 open · 342 proved · 9 translated.**
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 67 | 67 | 0 | 67 | 100.0% | 160 | 17675 |
...
**189 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 480 of 480 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-zmod-crt` | 33 | 33 | 100.0% | 0 | 1 | 0s | — |
