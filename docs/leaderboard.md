...
**4559 verified proofs · 4251 attributed · 308 historical/unknown · 1350 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 991 |
| Failed terminal runs | 359 |
| Decomposed after failure | 30 |
| Failed without decomposition | 329 |
| Run success rate | 73.4% |
| Provider attempts | 1470 |
| Failed attempts | 479 |
| Attempt yield | 67.4% |
| Recorded run time | 117h 17m |
| Median / p90 run time | 0s / 31m 17s |
| Verified successes per recorded hour | 8.45 |
| Proofs with run telemetry | 991 (21.7%) |

## Work Queue

**4818 goals · 2267 archived · 13 blocked · 225 open · 2304 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 1128 | 972 | 86.2% | 227 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 282 | 5.3% | 216 | 2763.0 | 300900 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 18.9 | 287865 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2176 | 2175 | 1 | 949 | 100.0% | 2179 | 0.0 | 272300 |
...
**4251 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4559 of 4559 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2174 | 949 | 100.0% | 0 | 1 | 0s | — |
