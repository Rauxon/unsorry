...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 1031 logged terminal runs.**
...
| Run success rate | 64.8% |
| Provider attempts | 1155 |
| Failed attempts | 487 |
| Attempt yield | 57.8% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 0s / 31m 27s |
| Verified successes per recorded hour | 5.52 |
| Proofs with run telemetry | 668 (14.5%) |

## Work Queue

**4870 goals · 2641 archived · 15 blocked · 224 open · 1981 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 806 | 649 | 80.5% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 626 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 626 | 100.0% | 0 | 1 | 0s | — |
