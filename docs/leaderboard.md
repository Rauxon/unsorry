...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 827 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 464 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 56.1% |
| Provider attempts | 951 |
| Failed attempts | 487 |
| Attempt yield | 48.8% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 0s / 31m 44s |
| Verified successes per recorded hour | 3.83 |
| Proofs with run telemetry | 464 (10.1%) |

## Work Queue

**4870 goals · 2845 archived · 15 blocked · 224 open · 1777 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 602 | 445 | 73.9% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 422 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 422 | 100.0% | 0 | 1 | 0s | — |
