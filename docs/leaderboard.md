...
**498 verified proofs · 207 attributed · 291 historical/unknown · 486 logged terminal runs.**
...
| Run success rate | 34.4% |
| Provider attempts | 536 |
| Failed attempts | 369 |
| Attempt yield | 31.2% |
| Recorded run time | 98h 5m |
| Median / p90 run time | 6m 0s / 31m 57s |
| Verified successes per recorded hour | 1.70 |
| Proofs with run telemetry | 167 (33.5%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 252 open · 360 proved · 9 translated.**
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 81 | 81 | 0 | 81 | 100.0% | 194 | 21425 |
...
**207 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 498 of 498 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-sum-induction` | 6 | 6 | 100.0% | 0 | 1 | 0s | — |
