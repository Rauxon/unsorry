...
**4099 verified proofs · 3791 attributed · 308 historical/unknown · 1189 logged terminal runs.**
...
| Proofs with run telemetry | 847 (20.7%) |

## Work Queue

**4171 goals · 2199 archived · 3 blocked · 51 open · 1909 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 332 | 22.0% | 287 | 2294.1 | 262885 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 1714 | 1467 | 247 | 0 | — | 2041 | 18.0 | 248750 |
...
**3791 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4099 of 4099 proof index files. It is used only where explicit `solver≜` provenance is missing.
