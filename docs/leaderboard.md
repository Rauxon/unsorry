...
**2613 verified proofs · 2305 attributed · 308 historical/unknown · 1164 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 824 |
| Failed terminal runs | 340 |
| Decomposed after failure | 20 |
| Failed without decomposition | 320 |
| Run success rate | 70.8% |
| Provider attempts | 1248 |
| Failed attempts | 424 |
| Attempt yield | 66.0% |
| Recorded run time | 92h 47m |
| Median / p90 run time | 0s / 31m 18s |
| Verified successes per recorded hour | 8.88 |
| Proofs with run telemetry | 824 (31.5%) |

## Work Queue

**2636 goals · 1791 archived · 3 blocked · 11 open · 822 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 861 | 784 | 91.1% | 133 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1561 | 1560 | 1 | 690 | 100.0% | 2438 | 0.0 | 282825 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 564 | 317 | 247 | 0 | — | 1525 | 0.0 | 166600 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 330 | 22.1% | 297 | 1070.1 | 141485 |
...
**2305 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2613 of 2613 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1696 | 807 | 100.0% | 0 | 3 | 0s | — |
