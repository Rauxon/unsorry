...
**689 verified proofs · 384 attributed · 305 historical/unknown · 642 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 323 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 50.3% |
| Provider attempts | 693 |
| Failed attempts | 370 |
| Attempt yield | 46.6% |
| Recorded run time | 96h 32m |
| Median / p90 run time | 3m 50s / 31m 44s |
| Verified successes per recorded hour | 3.35 |
| Proofs with run telemetry | 320 (46.4%) |

## Work Queue

**863 goals · 258 archived · 3 blocked · 162 open · 431 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 249 | 248 | 1 | 250 | 100.0% | 510 | 57225 |
...
**384 explicit solver credits · 305 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 689 of 689 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 69 | 69 | 100.0% | 0 | 1 | 0s | — |
