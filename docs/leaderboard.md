...
**2409 verified proofs · 2101 attributed · 308 historical/unknown · 1058 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 722 |
| Failed terminal runs | 336 |
| Decomposed after failure | 20 |
| Failed without decomposition | 316 |
| Run success rate | 68.2% |
| Provider attempts | 1136 |
| Failed attempts | 414 |
| Attempt yield | 63.6% |
| Recorded run time | 92h 26m |
| Median / p90 run time | 0s / 31m 21s |
| Verified successes per recorded hour | 7.81 |
| Proofs with run telemetry | 722 (30.0%) |

## Work Queue

**2432 goals · 1689 archived · 3 blocked · 11 open · 720 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 755 | 682 | 90.3% | 123 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1357 | 1356 | 1 | 587 | 100.0% | 2234 | 0.0 | 257325 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 564 | 317 | 247 | 0 | — | 1525 | 0.0 | 166600 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 330 | 22.1% | 297 | 908.1 | 125285 |
...
**2101 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2409 of 2409 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1492 | 705 | 100.0% | 0 | 3 | 0s | — |
