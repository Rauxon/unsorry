...
**1270 verified proofs · 962 attributed · 308 historical/unknown · 418 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 99 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 23.7% |
| Provider attempts | 461 |
| Failed attempts | 362 |
| Attempt yield | 21.5% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 26s / 32m 0s |
| Verified successes per recorded hour | 1.10 |
| Proofs with run telemetry | 99 (7.8%) |

## Work Queue

**1436 goals · 1173 archived · 3 blocked · 154 open · 97 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 115 | 59 | 51.3% | 71 | 2m 59s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 801 | 800 | 1 | 85 | 100.0% | 1706 | 190625 |
...
**962 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1270 of 1270 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 332 | 85 | 100.0% | 0 | 1 | 0s | — |
