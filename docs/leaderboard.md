...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 793 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 430 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 54.2% |
| Provider attempts | 917 |
| Failed attempts | 487 |
| Attempt yield | 46.9% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 1m 49s / 31m 46s |
| Verified successes per recorded hour | 3.55 |
| Proofs with run telemetry | 430 (9.3%) |

## Work Queue

**4870 goals · 2879 archived · 15 blocked · 224 open · 1743 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 568 | 411 | 72.4% | 230 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 286 | 5.2% | 216 | 2808.9 | 305490 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 18.9 | 287865 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 388 | 100.0% | 2230 | 0.0 | 278675 |
...
**4302 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4610 of 4610 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 388 | 100.0% | 0 | 1 | 0s | — |
| `lean / ring` | 1119 | 0 | — | 0 | 1 | — | — |
| `lean / decide` | 653 | 0 | — | 0 | 1 | — | — |
| `openrouter / unknown` | 160 | 0 | — | 0 | 1 | — | — |
| `claude / opus` | 72 | 78 | 48.7% | 114 | 6 | 10m 48s | 1.13 |
