...
**1117 verified proofs · 809 attributed · 308 historical/unknown · 385 logged terminal runs.**
...
| Proofs with run telemetry | 66 (5.9%) |

## Work Queue

**1283 goals · 1053 archived · 3 blocked · 154 open · 64 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 71 | 15 | 21.1% | 71 | 4m 53s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 648 | 647 | 1 | 52 | 100.0% | 1547 | 170900 |
...
**809 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1117 of 1117 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 182 | 41 | 100.0% | 0 | 1 | 0s | — |
