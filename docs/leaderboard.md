...
**2195 verified proofs · 1887 attributed · 308 historical/unknown · 844 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 508 |
| Failed terminal runs | 336 |
| Decomposed after failure | 20 |
| Failed without decomposition | 316 |
| Run success rate | 60.2% |
| Provider attempts | 922 |
| Failed attempts | 414 |
| Attempt yield | 55.1% |
| Recorded run time | 92h 26m |
| Median / p90 run time | 0s / 31m 27s |
| Verified successes per recorded hour | 5.50 |
| Proofs with run telemetry | 508 (23.1%) |

## Work Queue

**2218 goals · 1553 archived · 3 blocked · 11 open · 642 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 541 | 468 | 86.5% | 123 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1143 | 1142 | 1 | 373 | 100.0% | 2020 | 0.0 | 230575 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 564 | 317 | 247 | 0 | — | 1525 | 0.0 | 166600 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 330 | 22.1% | 297 | 729.0 | 107375 |
...
**1887 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2195 of 2195 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1276 | 489 | 100.0% | 0 | 3 | 0s | — |
