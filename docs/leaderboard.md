...
**773 verified proofs · 465 attributed · 308 historical/unknown · 377 logged terminal runs.**
...
| Run success rate | 15.4% |
| Provider attempts | 420 |
| Failed attempts | 362 |
| Attempt yield | 13.8% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 7m 28s / 32m 2s |
| Verified successes per recorded hour | 0.65 |
| Proofs with run telemetry | 58 (7.5%) |

## Work Queue

**939 goals · 703 archived · 3 blocked · 154 open · 70 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 83 | 27 | 32.5% | 71 | 4m 4s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 307 | 306 | 1 | 44 | 100.0% | 618 | 69475 |
...
**465 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 773 of 773 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 102 | 20 | 100.0% | 0 | 1 | 0s | — |
| `claude / template-zmod-decide` | 74 | 24 | 100.0% | 0 | 2 | 0s | — |
